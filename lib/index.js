...
var MarkovChainMecab = function () {
  function MarkovChainMecab(text, SENTENCE_COUNT) {
  ...
  _createClass(MarkovChainMecab, [{
    key: 'parse',
    value: function parse(text, SENTENCE_COUNT) {
      var _this = this;

      mecab.parse(text, function (err, items) {
        var dic = _this.makeDic(items);
        _this.makeSentence(dic, SENTENCE_COUNT);
      });
    }
  }, {
    key: 'makeDic',
    ...
    key: 'makeSentence',
    value: function makeSentence(dic, SENTENCE_COUNT) {
